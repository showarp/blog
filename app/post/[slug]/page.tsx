...
export default function PostPage() {
  ...
  // Note: Mermaid diagrams are now rendered via MermaidChart component
  // Removed duplicate mermaid.run() call that was causing rendering issues
